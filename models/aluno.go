...
type Aluno struct { /** Define a estrutura "Aluno" com quatro campos **/
	...
	CPF        string `json:"cpf" validate:"len=9"`    /** Campo "CPF" do tipo string, que será convertido para "cpf" no JSON e deve ter exatamente 9 caracteres **/
	RG         string `json:"rg" validate:"len=11"`    /** Campo "RG" do tipo string, que será convertido para "rg" no JSON e deve ter exatamente 11 caracteres **/
}
